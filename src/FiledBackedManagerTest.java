...
public class FiledBackedManagerTest {
    public static void main(String[] args) {
       TaskManager initialTaskManager = new FileBackedTasksManager(Paths.get("src/ru/tasktracker/storagefiles/StorageFile.txt"));
        ...
        TaskManager loadedTaskManager = FileBackedTasksManager.loadFromFile(Paths.get("src/ru/tasktracker/storagefiles/StorageFile.txt"));
